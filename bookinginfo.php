...
<html lang="en">
  ...
  <body>
    ...
    <div>
      <p style="font-size: 3rem; margin-left: 30rem; margin-top: -0.2rem; color: #003049;"><u>SLOT</u> <u>BOOKING</u>
        <u>DETAILS</u>
      </p>
    </div>
    <div class="table">
  ...
  border-right: 1px solid #ffffff;
  color: white;">TIME SLOT</th>
                <th class="g" style="font-size: 1.5rem;
  border-right: 1px solid #ffffff;
  color: white;">DATE</th>
                <th class="g" style="font-size: 1.5rem;
  border-right: 1px solid #ffffff;
  color: white;">VACCINE</th>
        ...
        <td style='text-align:centre;'>" . $result['stime'] . "</td>
        <td style='text-align:centre;'>" . $result['date'] . "</td>
        <td style='text-align:centre;'>" . $result['vname'] . "</td>
        </div>
